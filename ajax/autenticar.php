...
$inputUsuario = (isset($_REQUEST['inputUsuario']) && $_REQUEST['inputUsuario']!=NULL)?SanitizeVars::STRING($_REQUEST['inputUsuario'],5,15):false;
...
//var_dump($inputUsuario,$inputPerfil,$inputPassword);die;
