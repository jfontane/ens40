  ...
  <section class="container-fluid pb-4 pt-5"> <!--Cuerpo de página-->
    <section class="container-fluid pb-4 pt-5">
      ...
      <div class="container mt-2 mb-5">
        ...
        <form class="row g-3" action=""> <!--Aquí iría el inscribirseCarrera.php-->
          <div class="row">
            <div class="col-12">
              <hr>
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="inputDni" id="inputDni" style="font-family: 'Fredoka', sans-serif;" placeholder="Ingresa DNI">
            </div>
