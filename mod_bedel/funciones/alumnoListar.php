                  ...
                  <td align="center"><small><b><input type="checkbox" class=" check" id="check_<?=$rowIdCampo1?>" name="check_usu[]" value="<?=$rowIdCampo1?>"></b></small></td>
                      ...
                      <div class="btn-group pull-right" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
						  ...
						  <a class=" dropdown-item small" href="#" onclick="inscribirExamen('<?=$rowIdCampo1?>')"><i class="fa fa-graduation-cap"></i>&nbsp;Inscribir a Ex&aacute;men</a>
						  <a class=" dropdown-item small" href="#" onclick="blanquearPassword('<?=$rowCampo3?>')"><i class="fa fa-key"></i>&nbsp;Blanquear Contrase&ntilde;a</a>
				...
				<tr><td colspan="8">
							  <div class="alert alert-exclamation" role="alert">
									<span style="color: #000000;">
										...
										&nbsp;<strong>Atenci&iacute;n:</strong> No existen Resultados.
									</span>
							   </div>
						  </td></tr>
				</tbody>
